...
def state(state):
    ...
    def save(name):
        global im
        global draw
        filenamefullpath=os.path.normpath(os.path.join(targetdir,name))
    ...
    #def menuicon():
        #d=int(w*0.70/2.0)  # Python 3 division check: use // for integer division if needed
        #dy=int(w*0.24/2.0)  # Python 3 division check: use // for integer division if needed
        #if dy<2:dy=2
    ...
    def shadeicon(toggled):
        ...
        dy=int(w*0.24/2.0)  # Python 3 division check: use // for integer division if needed
        if dy<2:dy=2
        Dy=int(w*0.40/2.0)  # Python 3 division check: use // for integer division if needed
        global my
        my-=Dy
    ...
    def cross(mx,my,ts):
        d=int(w*0.45/2.0)  # Python 3 division check: use // for integer division if needed
    ...
    def maximizeicon(toggled):
        if toggled=='toggled':
            ...
            ts1=ts
            bs1=bs
        d=int(w*0.60/2.0)  # Python 3 division check: use // for integer division if needed
    ...
    def stickicon(toggled):
        if toggled=='toggled':
            ...
            ts1=ts
            bs1=bs
        d=int(w*0.40/2.0)  # Python 3 division check: use // for integer division if needed
        plus(mx,my,bs1,d)
...
def genXfwmThemerc(filename,opts):
    ...
    #in our cde setup titlebar consists of border+title. So add border/2, offset
